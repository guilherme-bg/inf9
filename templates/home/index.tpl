...
<html lang="en">
  ...
  <body>
          ...
          <div class="col-lg-12">
            ...
            >
              <div class="single_client_logo">
                <img src="{{url_for('static',filename='img/logo/Logo1.png')}}" alt="" />
              </div>
              <div class="single_client_logo">
                <img src="{{url_for('static',filename='img/logo/Logo2.png')}}" alt="" />
              </div>
              <div class="single_client_logo">
                <img src="{{url_for('static',filename='img/logo/Logo3.png')}}" alt="" />
              </div>
              <div class="single_client_logo">
                <img src="{{url_for('static',filename='img/logo/Logo4.png')}}" alt="" />
              </div>
              <div class="single_client_logo">
                <img src="{{url_for('static',filename='img/logo/Logo5.png')}}" alt="" />
              </div>
              <div class="single_client_logo">
                <img src="{{url_for('static',filename='img/logo/Logo6.png')}}" alt="" />
              </div>
              <div class="single_client_logo">
                <img src="{{url_for('static',filename='img/logo/Logo1.png')}}" alt="" />
              </div>
    ...
    <section class="our_project section_padding" id="portfolio">
        ...
        <div class="filters-content">
          <div class="row justify-content-between portfolio-grid">
            <div class="col-lg-6 col-sm-6 all buildings">
              <div class="single_our_project">
                <div class="single_offer">
                  <img src="{{url_for('static',filename='img/project_1.png')}}" alt="offer_img_1" />
            ...
            <div class="col-lg-6 col-sm-6 all rebuild">
              <div class="single_our_project">
                <div class="single_offer">
                  <img src="{{url_for('static',filename='img/project_2.png')}}" alt="offer_img_1" />
                  <div class="hover_text">
                    <p>Web design</p>
                    <a href="#"><h2>Web design & development</h2></a>
                  </div>
      ...
      <img src="{{url_for('static',filename='img/animate_icon/icon_2.png')}}" class="animation_icon_2" alt="">
    </section>
        ...
        <div class="row align-items-center justify-content-start">
          <div class="col-md-6 col-xl-6">
            <div class="creative_img">
              <img src="{{url_for('static',filename='img/creative_img.png')}}" alt="" />
            </div>
          </div>
    ...
    <div class="review_part padding_bottom" id="testimonial">
            ...
            <div class="review_part_text owl-carousel">
              <div class="singler_eview_part">
                <div class="client_info">
                  <img src="{{url_for('static',filename='img/client_1.png')}}" alt="" />
              ...
              <div class="singler_eview_part">
                <div class="client_info">
                  <img src="{{url_for('static',filename='img/client_2.png')}}" alt="" />
                  <h4>Danny Jonson</h4>
      ...
      <img src="{{url_for('static',filename='img/animate_icon/icon_3.png')}}" class="animation_icon_3" alt="">
    </div>
    <!--::review_part end::-->
        ...
        <div class="row justify-content-between">
          <div class="col-sm-6 col-md-3 col-xl-3">
            <div class="single-footer-widget footer_1">
              <a href="index.tpl">
                <img src="{{url_for('static',filename='img/footer_logo.png')}}" alt="" />
              </a>
              <ul>
                <li><a href="#">Work</a></li>
